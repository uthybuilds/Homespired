      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 pb-24 pt-32">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl font-semibold sm:text-5xl">
            Begin your Homespired journey.
          </h1>
          <p className="max-w-2xl text-base text-ash sm:text-lg">
            Join to access curated collections, saved spaces, and concierge
            support.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-ash/30 bg-linen p-8">
            <h2 className="text-2xl font-semibold text-obsidian">
              Already have an account?
            </h2>
            <p className="mt-3 text-sm text-ash">
              Sign in to review orders, manage your saved pieces, and request
              concierge support.
            </p>
            <NavLink
              to="/login"
